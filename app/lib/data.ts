...
export const successStories = [
    ...
    },
    {
        ...
        description: "By optimizing local SEO and enhancing Google Mu Business profiles, we increased visibility, driving a 300% boost in online reservations and foot traffic.",
    },
    {
...
export const workProcess = [
    ...
    },
    {
        ...
        description: "Hight-quality content is key to SEO. We create or refine content that engages your audience while aligning with search engine algorithms."
    },
    {
        order: "05",
        title: "Link Building",
...
export const useCasesData = [
    ...
    {
        title: "Local Restaurant Chain",
        description: "By optimizing local SEO and enhancing Google My Business profiles, we increase visibility, driving a 300% boost in online reservations and  foot traffic."
    },
    {
        title: "Healthcare Provider",
        description: "Through content optimization and targeted keyword strategy, we helped a healthcare provider rank on the first page for critical services, resulting in a 180% increase in inquiries and patient bookings."
